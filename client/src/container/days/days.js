                    ...
                    <div className="weather__daycards">
                        <div className={`weather__daycards-container${index === 0 ? ' active' : ''}`} onClick={() => { setIndex(0) }}>
                            {(typeof data.main != 'undefined') ? (
                                <DayCards date={moment().format('ddd, Do MMM')} temp1={data.main.temp_max} temp2={data.main.temp_min} humid="54%" wind1="10km/h" />
                            ) : (<div></div>)}
                        </div>
                    </div >
                </div>
                    ...
                    <div className="weather__daycards">
                        <div className={`weather__daycards-container${index === 1 ? ' active' : ''}`} onClick={() => { setIndex(1) }}>
                            {(typeof forecast.data != 'undefined') ? (
                                <DayCards desc={forecast.data[1].weather.description} date={moment().add(1, 'days').format('ddd, Do MMM')} temp1={forecast.data[1].max_temp} temp2={forecast.data[1].min_temp} humid="54%" wind1="10km/h" />
                            ) : (<div></div>)}
                        </div>
                    </div >
                </div>
                ...
                <div className="day3">
                    <div className="weather__daycards">
                        <div className={`weather__daycards-container${index === 2 ? ' active' : ''}`} onClick={() => { setIndex(2) }}>
                            {(typeof forecast.data != 'undefined') ? (
                                <DayCards date={moment().add(2, 'days').format('ddd, Do MMM')} temp1={forecast.data[2].max_temp} temp2={forecast.data[2].min_temp} />
                            ) : (<div></div>)}
                        </div>
                    </div >
                </div>
                ...
                <div className="day4">
                    <div className="weather__daycards">
                        <div className={`weather__daycards-container${index === 3 ? ' active' : ''}`} onClick={() => { setIndex(3) }}>
                            {(typeof forecast.data != 'undefined') ? (
                                <DayCards date={moment().add(3, 'days').format('ddd, Do MMM')} temp1={forecast.data[3].max_temp} temp2={forecast.data[3].min_temp} />
                            ) : (<div></div>)}
                        </div>
                    </div >
                </div>
                ...
                <div className="day5">
                    <div className="weather__daycards">
                        <div className={`weather__daycards-container${index === 4 ? ' active' : ''}`} onClick={() => { setIndex(4) }}>
                            {(typeof forecast.data != 'undefined') ? (
                                <DayCards date={moment().add(4, 'days').format('ddd, Do MMM')} temp1={forecast.data[4].max_temp} temp2={forecast.data[4].min_temp} />
                            ) : (<div></div>)}
                        </div>
                    </div >
                </div>
